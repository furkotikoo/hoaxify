...
const ProfileCard = props => {
    ...
    const deleteUserProgress = useApiProgress('delete', `/api/1.0/users/${username}`, true);

    const onClickDelete = async () => {
        await deleteUser(username);
        setModalVisible(false);
        dispatch(logoutSuccess());
        history.push('/'); // HomePage sayfasını görüntüleyecek
    };
    ...
    return (
        <>
                    ...
                    {inEditMode &&
                        <div>
                            ...
                            <div>
                                ...
                                />
                                <button
                                    className="btn btn-primary btn-light d-inline-flex ml-1"
            ...
            <Modal
                ...
                pendingApiCall={deleteUserProgress}
