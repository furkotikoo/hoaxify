...
public class HoaxController {
	...
	@PreAuthorize("@hoaxSecurity.isAllowedToDelete(#id, principal)") //principal=loggedInUser ı ifade ediyor // başına @ koyduğumuzda spring in kendi içnddeki bir bean olduğunn referansını veriyoruz
